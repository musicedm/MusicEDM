...
public class WaveView extends View{
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#CC000000");
    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#E6000000");
